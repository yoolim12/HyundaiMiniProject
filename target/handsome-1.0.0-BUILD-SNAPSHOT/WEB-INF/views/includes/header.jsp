...
<link rel="stylesheet" type="text/css"	href="resources/css/main_201903.css" media="all">
 -->
      ...
      <link rel="stylesheet" type="text/css" href="/resources/css/selectshop.css" media="all">
      <link rel="stylesheet" type="text/css" href="/resources/css/beauty.css" media="all">

      <link rel="stylesheet" type="text/css" href="/resources/css/print.css" media="all">
      <link rel="stylesheet" type="text/css" href="/resources/css/products.css" media="all"> 
 	
	  <script type="text/javascript" src="/resources/js/handsome/common_function.js"></script>
	  ...
	  <script type="text/javascript" src="/resources/js/handsome/jquery.bxslider.min.js"></script>
	  <script type="text/javascript" src="/resources/js/handsome/jquery.flexslider.min.js"></script>
		<script type="text/javascript" src="/resources/js/handsome/swiper.min.js"></script>
		...
		<script type="text/javascript" src="/resources/js/netfunnel_skin.js"></script>
		<script type="text/javascript" src="/resources/js/netfunnel.js"></script>
		...
		<script type="text/javascript" src="/resources/js/videojs-ie8.js"></script>

		<script type="text/javascript" src="/resources/js/common/wisenut/arkjs"></script>
		<script type="text/javascript" src="/resources/js/common/wisenut/beta.fix.js"></script>
		<script type="text/javascript" src="/resources/js/common/wisenut/jquery.min.js"></script>
		<script type="text/javascript" src="/resources/js/common/wisenut/search.js"></script>
...
<!-- 			<script type="text/javascript"
				src="/resources/js/common/wisenut/beta.fix.js"></script>
			<script type="text/javascript"
				src="/resources/js/common/wisenut/ark.js"></script>
			<script type="text/javascript"
				src="/resources/js/common/wisenut/search.js"></script>
 -->
			<script type="text/javascript">
				//<![CDATA[
				// #1067 - 201803 메인 개편
											...
											if (weekName != "일요일"
												...
												$
														.ajax({
															...
															data : {
																"CSRFToken" : "a0934285-0aa1-4a80-b7ef-25c4ef88c055"
															},
															async : false,
															success : function(
																	result) {
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search" action="/ko/hssearch/searchCount"
							...
							<input type="hidden" name="CSRFToken"
								value="926c3cad-f09b-44ff-a961-7a52d2bc71a0"> <input
					...
					<ul class="cate_m cate_banner gnbul1" id="cate_m_main">
						<li><a href="javascript:void(0);" class="gnb_brand"
							...
							<div class="sub_back" style="height: 0px; border-bottom: 0px;">
								<div class="sub_menu clearfix" style="display: none;">
									<p class="gnbbr_txt" style="margin-left: 450.5px;">브랜드 명을
										클릭하시면 해당 브랜드로 이동합니다.</p>
									...
									<p class="gnbbr_txt" style="margin-left: 321px;">로그인 후 좋아하는
										브랜드를 ♥해주세요. '적용하기' 버튼을 클릭하면 웹사이트 상단에 추가됩니다.</p>
									<br>
									<div class="br_button_wrap" style="margin-left: 483px;">
						...
						<li><a href="/ko/c/as"
							...
							<div class="sub_back" style="height: 0px; border-bottom: 0px;">
								<div class="sub_menu clearfix" style="display: none;">
									<ul class="al_frt1 sm_dep1"
										style="margin-left: 165px; margin-bottom: 25px; float: right;">
										<li><a href="/ko/c/as"
