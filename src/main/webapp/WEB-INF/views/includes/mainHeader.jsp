...
//]]>
		...
		<div class="top_nav topnav1903">
			<div class="top_nav_wrap clearfix">
				<div class="brand_menu brand_menu1903">
					<ul class="clearfix">
						<!-- 선호 브랜드 없음 -->
						<li><span class="on"><a href="/mainpage"
		...
		<div class="gnbwarp com clearfix">
			<h1 class="logo logo1903">
				<a href="${contextPath }/" onclick="GA_Event('공통', '로고', '상단');">thehandsome.com</a>
			</h1>
						...
						<div class="sub_back">
							<div class="sub_menu clearfix" style="">
								<ul class="al_frt1 sm_dep1">
									...
									<li><a href="${contextPath}/product/productMList?category=스킨케어&pageNum=1&amount=12"
										onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_스킨케어');">스킨케어</a>
										<ul class="clearfix sm_dep2">
											<li><a href="${contextPath}/product/productSList?category=토너/에멀전/크림&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_토너/에멀전/크림');">토너/에멀전/크림</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=세럼/앰플/오일/밤&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_세럼/앰플/오일/밤');">세럼/앰플/오일/밤</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=클렌징/스크럽/마스크&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_스킨케어_클렌징/스크럽/마스크');">클렌징/스크럽/마스크</a>
											</li>
										</ul></li>
									<!--  status2.last end -->
									<li><a href="${contextPath}/product/productMList?category=바디/헤어케어&pageNum=1&amount=12"
										onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_바디/헤어케어');">바디/헤어케어</a>
										<ul class="clearfix sm_dep2">
											<li><a href="${contextPath}/product/productSList?category=핸드·바디로션/크림/오일&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_핸드·바디로션/크림/오일');">핸드·바디로션/크림/오일</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=핸드·바디워시/스크럽&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_핸드·바디워시/스크럽');">핸드·바디워시/스크럽</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=샴푸/컨디셔너&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_샴푸/컨디셔너');">샴푸/컨디셔너</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=트리트먼트/오일/스프레이&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_트리트먼트/오일/스프레이');">트리트먼트/오일/스프레이</a>
											</li>
											<li><a href="${contextPath}/product/productSList?category=기타바디/헤어케어&pageNum=1&amount=12"
												onclick="GA_Event('공통_카테고리','3DEPTH','뷰티_바디/헤어케어_기타 바디/헤어케어');">기타바디/헤어케어</a></li>
										</ul></li>
									<!--  status2.last end -->
									<li style="margin-right: 0px"><a href="${contextPath}/product/productMList?category=향수&pageNum=1&amount=12"
										onclick="GA_Event('공통_카테고리','2DEPTH','뷰티_향수');">향수</a>
										<ul class="clearfix sm_dep2">
											<li><a href="${contextPath}/product/productSList?category=향수&pageNum=1&amount=12"
			...
			<div class="util_menu util_menu1803">
				<ul class="clearfix">
					...
					<li><a href="/order/orderList?mid="+${member}
