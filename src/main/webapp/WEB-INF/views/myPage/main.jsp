...
function dayClose(cName, cValue, cDay) {
	...
	<div class="profile_info1 clearfix review_betterment1905">
		<div class="name type2">
			<span class="ico_grade">${member.getMName()}&nbsp;<span>님</span></span> <span
				class="grade_txt"></span>
		</div>
		<div class="point" style="border: 0; padding-left: 0; width: 95px">
			<p class="title">COUPON</p>
			<a class="count" href="/ko/mypage/voucher"
				onclick="GA_Event('마이페이지','회원정보','COUPON');">0&nbsp;<span>장</span></a>
		</div>
		...
		<div class="point type2">
			<p class="title2">
				간편회원은 H.Point / 한섬마일리지 적립과 사용이 불가합니다. <br>혜택을 받으시려면, H.Point
				통합회원으로 가입해주세요.
			</p>
			<a href="javascript:void(0);" id="hpoinJoin" class="btn"
				onclick="GA_Event('마이페이지','회원정보','H.POINT 회원가입');">H.Point 회원가입</a>
		</div>
	</div>
	<!-- 회원정보 -->
	<!-- 최근주문 -->
	<div class="title_wrap">
		...
		<div class="btn_wrap">
			<a href="/ko/mypage/order/myorders" class="btn add_ss"
	...
	<ul class="wish_wrap">
		<li class="no_data">위시리스트에 저장된 상품이 없습니다.<!-- 위시리스트에 저장된 상품이 없습니다. -->
		</li>
	</ul>
